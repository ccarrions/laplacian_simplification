...
% Example:
% 
% [1] hippolefts = lb_smooth([],hippoleft, 0.2, 500, V, D);
%     It smooths surface mesh hippolef with sigma = 0.2 and 500 
%     eigenfunctions. See [3] for detail.    
%
%
%
% If you use the part of the code, please reference [3]. The details on
% the mathematical basis of of the algorithm can be found in [3].
% Computation for the eigenfunctions of the Laplace-Beltrami is based on
% FEM discretization given in [1] and [2].
%
%
...
%
% Update history: April 23, 2010; July 16, 2011
